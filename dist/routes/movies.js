...
// @scripts
const movies_1 = require("src/utils/schemas/movies");
const validationHandler_1 = __importDefault(require("src/utils/middleware/validationHandler"));
const scopesValidationHandler_1 = __importDefault(require("src/utils/middleware/scopesValidationHandler"));
const cacheResponse_1 = __importDefault(require("src/utils/cacheResponse"));
const time_1 = require("src/utils/time");
const movies_2 = __importDefault(require("src/services/movies"));
const genres_1 = __importDefault(require("src/services/genres"));
