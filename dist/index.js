...
const errorHandlers_1 = require("./utils/middleware/errorHandlers");
const notFoundHandler_1 = __importDefault(require("./utils/middleware/notFoundHandler"));
// @/routes
const auth_1 = __importDefault(require("./routes/auth"));
const movies_1 = __importDefault(require("./routes/movies"));
const genres_1 = __importDefault(require("./routes/genres"));
const userMovies_1 = __importDefault(require("./routes/userMovies"));
